...
// Pass arguments from the other controllers.
// This is the central place to decide what happens on each event and delegate the tasks to the other controllers
var controller = (function (budgetCtrl, UICtrl) {
  ...
  var ctrlDeleteItem = function (event) {
    ...
    if (itemID) {
      ...
      // 3. Update and show the new update
      updateBudget();
    }
  };
